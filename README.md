...
- DocumentsFilter checks [DOCX (**not DOC**)](https://www.howtogeek.com/304622/WHAT-IS-A-.DOCX-FILE-AND-HOW-IS-IT-DIFFERENT-FROM-A-.DOC-FILE-IN-MICROSOFT-WORD/) and PDF. If files to folder contains files with other extensions (DOC, JPEG, CSV, TXT, etc.) they will be ignored. This could change in future releases.
